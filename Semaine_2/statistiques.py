from requests import get """Requests est un module Python que vous pouvez utiliser pour envoyer toutes sortes de requêtes HTTP."""
import re """la bibliothèque 're' est utilisée pour travailler avec des expressions régulières."""
import bs4 """bs4 permet d'analyser des données à partir de fichiers HTML."""
import sys
...
def extrait_arbre(nom_pays):
    """Prends un nom de pays en chaine de caractères et retourne la représentation en arbre de sa page wikipédia."""
